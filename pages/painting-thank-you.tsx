...
const PaintingThankYouHigh: NextPageWithLayout = () => {
    ...
    useEffect(() => {
        const canAccess = sessionStorage.getItem('canAccessThankYouHigh');
        if (!canAccess) {
            ...
            <div className="flex flex-col items-center min-h-screen relative text-white pb-20 challenge-page-gradient">
                <div className="w-full px-4 sm:px-6 lg:px-6 py-8 sm:py-10 text-center z-10">
                    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
                        ...
                        <p className="text-2xl md:text-4xl">You're ready to get started, and we're thrilled to serve you.</p>
                        ...
                        <p className="text-xl md:text-2xl font-semibold bg-white/10 p-4 rounded-lg shadow-md">Check your email for the full bundle: Color Palette, Mistake Checklist, and Estimator Tool.<br></br>⬇️ You can also access them below ⬇️</p>
                        ...
                        <button 
                            onClick={() => router.push('/painting-landing?utm_source=thank_you_high')}
