                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl shadow-xl transform hover:scale-105 transition-transform">
                                <Image
                                    ...
                                    unoptimized
                                />
                                <p className="text-lg font-medium">Stunning transformations await!</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl shadow-xl transform hover:scale-105 transition-transform">
                                <Image
                                    ...
                                    unoptimized
                                />
                                <p className="text-lg font-medium">Expert craftsmanship guaranteed.</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl shadow-xl transform hover:scale-105 transition-transform">
                                <Image
                                    ...
                                    unoptimized
                                />
                                <p className="text-lg font-medium">Join our delighted clients.</p>
                            </div>
                        </div>
