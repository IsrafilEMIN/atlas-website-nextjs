// src/pages/painting-thank-you-mid.tsx
...
const PaintingThankYouMid: NextPageWithLayout = () => {
    const router = useRouter();
    const [name, setName] = useState('Valued Customer');

    useEffect(() => {
        const canAccess = sessionStorage.getItem('canAccessThankYouMid');
        if (!canAccess) {
            ...
            <div className="flex flex-col items-center min-h-screen relative text-white pb-20 challenge-page-gradient">
                <div className="w-full px-4 sm:px-6 lg:px-6 py-8 sm:py-10 text-center z-10">
                    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
                        ...
                        <p className="text-2xl md:text-4xl">Failing to plan is planning to fail. We're glad you're planning ahead!</p>
                        <p className="text-2xl md:text-4xl">Hope the guides below help you plan until we connect.</p>
                        ...
                        <p className="text-2xl mt-8">Our team will reach out to you ASAP (within 1 hour between 8AM - 8PM)</p>
                        <p className="text-xl md:text-2xl font-semibold bg-white/10 p-4 rounded-lg shadow-md">Check your email for the Palette and Checklist.<br></br>⬇️ You can also access them below ⬇️</p>
                        <div className="flex flex-col space-y-4">
                            ...
                            <a href="/mistake-checklist.pdf" download className="bg-[#093373] text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-blue-800 transition-colors shadow-lg">Download Mistake Checklist PDF</a>
                        </div>
                        ...
                        <button 
                            onClick={() => router.push('/painting-landing?utm_source=thank_you_mid')}
...
PaintingThankYouMid.getLayout = function getLayout(page: React.ReactElement) {
    return <MinimalLayout>{page}</MinimalLayout>;
};

export default PaintingThankYouMid;