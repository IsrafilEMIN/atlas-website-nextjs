...
const RoomModal: React.FC<RoomModalProps> = ({ room, onSave, onClose }) => {
    ...
    const [fieldErrors, setFieldErrors] = useState<{ [key in keyof Room]?: string }>({});
            ...
            case 'Bedroom':
                ...
                return (
                    ...
                    <div>
                        ...
                        <input type="number" id="closet-doors" name="closetDoors" value={formData.closetDoors} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.closetDoors ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                        ...
                        {formData.paintVanity && (
                            ...
                            <div className="grid grid-cols-2 gap-4 pl-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="vanity-doors" name="vanityDoors" value={formData.vanityDoors} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.vanityDoors ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                                ...
                                <div>
                                    ...
                                    <input type="number" id="vanity-drawers" name="vanityDrawers" value={formData.vanityDrawers} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.vanityDrawers ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                        ...
                        {formData.paintCabinets && (
                            ...
                            <div className="grid grid-cols-2 gap-4 pl-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="cabinet-doors" name="cabinetDoors" value={formData.cabinetDoors} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.cabinetDoors ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                                ...
                                <div>
                                    ...
                                    <input type="number" id="cabinet-drawers" name="cabinetDrawers" value={formData.cabinetDrawers} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.cabinetDrawers ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="room-length" name="length" value={formData.length} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.length ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} placeholder="e.g., 12" />
                        ...
                        <div>
                            ...
                            <input type="number" id="room-width" name="width" value={formData.width} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.width ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} placeholder="e.g., 15" />
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <input type="number" name="doors" value={formData.doors} onChange={handleChange} className={`block w-20 rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.doors ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'} `} placeholder="Qty" disabled={!formData.paintDoorsCheck} />
...
const ExteriorModal: React.FC<ExteriorModalProps> = ({ item, onSave, onClose }) => {
    ...
    const [fieldErrors, setFieldErrors] = useState<{ [key in keyof ExteriorItem]?: string }>({});
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="surface-sqft" name="sqft" value={formData.sqft} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.sqft ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} placeholder="e.g., 1500" />

                            {fieldErrors.sqft && <p className="text-red-500 text-sm mt-1">{fieldErrors.sqft}</p>}

                        </div>

                        <div><label htmlFor="stories" className="block text-sm font-medium text-gray-700">Number of Stories</label><select id="stories" name="stories" value={formData.stories} onChange={handleChange} className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-[#093373] focus:border-[#093373]"><option value="1">1 Story</option><option value="2">2 Stories</option><option value="3">3 Stories</option></select></div>
                    ...
                    <div>
                        ...
                        <input type="number" id="exterior-trim-lft" name="trimLft" value={formData.trimLft} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.trimLft ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                    ...
                    <div>
                        ...
                        <input type="number" id="exterior-doors-qty" name="doors" value={formData.doors} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.doors ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                    ...
                    <div className="pt-4 border-t">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="shutters" name="shutters" value={formData.shutters} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.shutters ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                            ...
                            <div>
                                ...
                                <input type="number" id="window-frames" name="windowFrames" value={formData.windowFrames} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.windowFrames ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                            ...
                            <div>
                                ...
                                <input type="number" id="gutter-lft" name="gutterLft" value={formData.gutterLft} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.gutterLft ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
                            ...
                            <div>
                                ...
                                <input type="number" id="deck-sqft" name="deckSqft" value={formData.deckSqft} onChange={handleChange} className={`mt-1 block w-full rounded-md shadow-sm focus:ring-[#093373] ${fieldErrors.deckSqft ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#093373] focus:ring-[#093373]'}`} />
