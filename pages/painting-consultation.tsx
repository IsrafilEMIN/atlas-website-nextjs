// pages/painting-consultation.tsx
...
const PaintingConsultation: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    ...
    if (canAccess === 'true') {
      ...
      router.replace('/painting-landing');
    }
  }, [router]);
...
PaintingConsultation.getLayout = function getLayout(page: React.ReactElement) {
