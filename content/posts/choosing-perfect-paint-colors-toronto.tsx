export const metadata = {
    ...
    excerpt:
        "Discover expert strategies for selecting ideal paint colors for residential and commercial spaces in Toronto. Learn about color psychology, architectural harmony, and professional consultation services to achieve beautiful, lasting results.",
    content: `
## Introduction
